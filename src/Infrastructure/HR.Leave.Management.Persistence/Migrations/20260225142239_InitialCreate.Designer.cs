...
namespace HR.Leave.Management.Persistence.Migrations
{
    ...
    [Migration("20260225142239_InitialCreate")]
            ...
            modelBuilder.Entity("HR.Leave.Management.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2026, 2, 25, 14, 22, 39, 190, DateTimeKind.Utc).AddTicks(658),
                            DefaultDays = 10,
                            Name = "Vacation"
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2026, 2, 25, 14, 22, 39, 190, DateTimeKind.Utc).AddTicks(1318),
                            DefaultDays = 12,
                            Name = "Sick"
                        },
                        new
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2026, 2, 25, 14, 22, 39, 190, DateTimeKind.Utc).AddTicks(1320),
                            DefaultDays = 90,
                            Name = "Maternity"
                        });
                });
